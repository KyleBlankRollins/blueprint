---
title: Theme Plugin Authoring Guide
description: Complete guide to creating custom theme plugins for Blueprint's design system
category: guides
order: 1
---
...
You can also create a plugin manually by extending the `ThemeBase` class:
...
export class OceanTheme extends ThemeBase {
  ...
  readonly description = 'A calming ocean-inspired color palette';
...
Every plugin class must implement:

```typescript
export class MyTheme extends ThemeBase {
  readonly id = 'my-theme'; // Unique identifier (kebab-case)
  readonly version = '1.0.0'; // Semver version (e.g., '1.0.0')
...
export class OceanTheme extends ThemeBase {
  ...
  readonly homepage = 'https://github.com/yourname/ocean-theme';
  readonly tags = ['blue', 'ocean', 'calming', 'professional'];
...
export class OceanTheme extends ThemeBase {
  ...
  readonly peerPlugins = ['dark-mode-enhancer'];
...
Add custom validation logic by implementing the `validate` method:
...
export class ForestTheme extends ThemeBase {
  readonly id = 'forest';
  readonly version = '1.0.0';
  readonly name = 'Forest Theme';
  readonly description = 'Nature-inspired greens and earth tones';
...
export class OceanProTheme extends ThemeBase {
  readonly id = 'ocean-pro';
  readonly version = '1.0.0';
  readonly name = 'Ocean Pro Theme';
  readonly description =
    'Professional variant of Ocean theme with enhanced contrast';
...
export const oceanProTheme = new OceanProTheme();
...
export class BrandTheme extends ThemeBase {
  readonly id = 'brand';
  readonly version = '1.0.0';
...
export const brandTheme = new BrandTheme();
```
...
- [API Reference](/themes/api-reference) - Complete ThemeBuilder API documentation
- [Best Practices](/themes/best-practices) - Advanced techniques and patterns
- [Type Generation](/themes/type-generation) - Understanding type generation
