---
title: ThemeBuilder API Reference
description: Complete API documentation for Blueprint's theme system
category: guides
order: 2
---
...
- [Plugin Authoring Guide](/themes/plugin-authoring-guide) - Learn to create theme plugins
- [Best Practices](/themes/best-practices) - Theme development best practices
- [Type Generation](/themes/type-generation) - TypeScript type generation details
