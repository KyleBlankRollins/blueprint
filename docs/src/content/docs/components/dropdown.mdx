  ...
  <bp-dropdown>
    ...
    <div slot="content" style="padding: 1rem; min-width: 200px;">
      <div style="display: flex; flex-direction: column; gap: 0.5rem;">
        <bp-button variant="text" size="small">Edit</bp-button>
        <bp-button variant="text" size="small">Duplicate</bp-button>
        <bp-button variant="text" size="small">Delete</bp-button>
      </div>
    </div>
  </bp-dropdown>
</ComponentPreview>
