...
```javascript
import '@krollins/blueprint/table';
```
...
```html
<bp-table size="sm">...</bp-table>
<bp-table size="md">...</bp-table>
<bp-table size="lg">...</bp-table>
```
...
table.columns = [
  ...
  },
  {
    ...
    render: (value, row) => {
      return html`
        <bp-button size="sm" variant="secondary">Edit</bp-button>
      `;
    },
  },
];
...
<bp-table>
  <div slot="empty">
    ...
    <bp-button size="sm">Add Item</bp-button>
  </div>
</bp-table>
```
