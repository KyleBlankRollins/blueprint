...
```javascript
import '@krollins/blueprint/menu';
```
...
<ComponentPreview>
  <bp-menu>
    <bp-menu-item value="cut">
      <bp-icon slot="prefix" name="clipboard-cross"></bp-icon>
      Cut
    </bp-menu-item>
    <bp-menu-item value="copy">
      <bp-icon slot="prefix" name="clipboard-copy"></bp-icon>
      Copy
    </bp-menu-item>
...
```html
<bp-menu size="sm">...</bp-menu>
<bp-menu size="md">...</bp-menu>
<bp-menu size="lg">...</bp-menu>
```
...
| -------- | -------------------------------- | ---------- | ----------------------- |
| `size`   | `'sm' \| 'md' \| 'lg'`           | `'md'`     | Size for all menu items |
