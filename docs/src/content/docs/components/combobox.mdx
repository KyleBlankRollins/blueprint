...
```javascript
import '@krollins/blueprint/combobox';
```
...
<ComponentPreview>
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    <bp-combobox size="sm" placeholder="Small">
      <option value="1">Option 1</option>
      <option value="2">Option 2</option>
    </bp-combobox>
    <bp-combobox size="md" placeholder="Medium">
      <option value="1">Option 1</option>
      <option value="2">Option 2</option>
    </bp-combobox>
    <bp-combobox size="lg" placeholder="Large">
      <option value="1">Option 1</option>
      <option value="2">Option 2</option>
    </bp-combobox>
  </div>
...
```html
<bp-combobox size="sm" placeholder="Small">...</bp-combobox>
<bp-combobox size="md" placeholder="Medium">...</bp-combobox>
<bp-combobox size="lg" placeholder="Large">...</bp-combobox>
```
