...
```javascript
import '@krollins/blueprint/file-upload';
```
...
<ComponentPreview>
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    <bp-file-upload size="sm" label="Small uploader"></bp-file-upload>
    <bp-file-upload size="md" label="Medium uploader"></bp-file-upload>
    <bp-file-upload size="lg" label="Large uploader"></bp-file-upload>
  </div>
</ComponentPreview>

```html
<bp-file-upload size="sm" label="Small"></bp-file-upload>
<bp-file-upload size="md" label="Medium"></bp-file-upload>
<bp-file-upload size="lg" label="Large"></bp-file-upload>
```
