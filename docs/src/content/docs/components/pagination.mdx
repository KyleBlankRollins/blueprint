...
```javascript
import '@krollins/blueprint/pagination';
```
...
<ComponentPreview>
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    <bp-pagination size="sm" current-page="3" total-pages="10"></bp-pagination>
    <bp-pagination size="md" current-page="3" total-pages="10"></bp-pagination>
    <bp-pagination size="lg" current-page="3" total-pages="10"></bp-pagination>
  </div>
</ComponentPreview>
