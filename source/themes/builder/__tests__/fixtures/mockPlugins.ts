...
export class ThemeVariantPlugin extends ThemeBase {
  ...
  register(builder: ThemeBuilderInterface) {
    ...
    builder.addThemeVariant('light', {
      ...
      secondaryHover: builder.colors.gray600,
      link: builder.colors.testBlue500,
      linkHover: builder.colors.testBlue600,
      linkVisited: builder.colors.testBlue700,
      success: builder.colors.gray500,
      successHover: builder.colors.gray600,
      successBg: builder.colors.gray100,
      warning: builder.colors.gray500,
      warningHover: builder.colors.gray600,
      warningBg: builder.colors.gray100,
      error: builder.colors.gray500,
      errorHover: builder.colors.gray600,
      errorBg: builder.colors.gray100,
      info: builder.colors.testBlue500,
      infoHover: builder.colors.testBlue600,
      infoBg: builder.colors.gray100,
      hoverOverlay: builder.colors.gray100,
      activeOverlay: builder.colors.gray200,
      selectedBg: builder.colors.testBlue100,
      placeholder: builder.colors.gray400,
      inputBg: builder.colors.gray50,
      inputBorder: builder.colors.gray300,
