  ...
  describe('Validation', () => {
    it('should validate successfully with complete theme', () => {
      ...
      builder.addThemeVariant('dark', {
        ...
        secondary: builder.colors.gray500,
        secondaryHover: builder.colors.gray400,
        link: builder.colors.testBlue400,
        linkHover: builder.colors.testBlue300,
        linkVisited: builder.colors.testBlue200,
        success: builder.colors.gray500,
        successHover: builder.colors.gray400,
        successBg: builder.colors.gray900,
        warning: builder.colors.gray500,
        warningHover: builder.colors.gray400,
        warningBg: builder.colors.gray900,
        error: builder.colors.gray500,
        errorHover: builder.colors.gray400,
        errorBg: builder.colors.gray900,
        info: builder.colors.testBlue400,
        infoHover: builder.colors.testBlue300,
        infoBg: builder.colors.gray900,
        hoverOverlay: builder.colors.gray800,
        activeOverlay: builder.colors.gray700,
        selectedBg: builder.colors.testBlue900,
        placeholder: builder.colors.gray600,
        inputBg: builder.colors.gray900,
        inputBorder: builder.colors.gray700,
